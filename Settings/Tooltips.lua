...
ns.SettingTooltips = {
    ...
    PERSONAL_DEATH_NOTIFICATIONS = "TOOLTIP_PERSONAL_DEATH_NOTIFICATIONS",
    PERSONAL_DEATH_SOUND = "TOOLTIP_PERSONAL_DEATH_SOUND",
    PERSONAL_DEATH_COMBAT = "TOOLTIP_PERSONAL_DEATH_COMBAT",
